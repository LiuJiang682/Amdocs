...
/**
 * Forward East command executer.
 * @author Jiang Liu
 *
 */
public class ForwardEastCommandExecuter implements CommandExecuter, Serializable {
	...
	public ForwardEastCommandExecuter(Command command) {
